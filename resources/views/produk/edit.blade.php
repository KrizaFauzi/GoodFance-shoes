        ...
        <div class="card-body">
          ...
          <form action="{{ route('produk.update', $itemproduk->id) }}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="kode_produk" id="kode_produk" readonly value={{ $itemproduk->kode_produk }} class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="slug_produk" id="slug_produk" readonly value={{ $itemproduk->slug_produk }} class="form-control">
            </div>
            <div class="form-group">
